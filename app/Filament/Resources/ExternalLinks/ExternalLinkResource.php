...
class ExternalLinkResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Linki zewnętrzne';
    protected static ?string $pluralLabel = 'Linki zewnętrzne';

    protected static string|null|\UnitEnum $navigationGroup = 'Links';
